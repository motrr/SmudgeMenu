...
class SMGHandles : NSObject, SMGHandleViewDelegate {
    
    var delegate:SMGHandlesDelegate?
    
    var startHandle:SMGHandleView = SMGHandleView(colour: UIColor.redColor())
    var endHandle:SMGHandleView = SMGHandleView(colour: UIColor.redColor())
    
    var startHandleHelper:SMGCircleView = SMGCircleView(colour: UIColor.blueColor())
    var endHandleHelper:SMGCircleView = SMGCircleView(colour: UIColor.yellowColor())
