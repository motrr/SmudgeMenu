...
// SmudgeMenu
#define COCOAPODS_POD_AVAILABLE_SmudgeMenu
#define COCOAPODS_VERSION_MAJOR_SmudgeMenu 0
#define COCOAPODS_VERSION_MINOR_SmudgeMenu 1
#define COCOAPODS_VERSION_PATCH_SmudgeMenu 0
